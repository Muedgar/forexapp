...
export default function Select({whichTransaction}:any) {
  ...
  return (
    <Listbox value={selected} onChange={(e) => {
      ...
      {({ open }) => (
        <>
          <Listbox.Label className="block text-sm font-medium text-gray-700">Select types of transactions</Listbox.Label>
