...
export default function CreateSending({ id, getData, onClose }: any) {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      if (id) {
        await updatesending(id, formData);
      } else {
        await createsending(formData);
      }
      reset()
      getData();
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 divide-y divide-gray-200">
      <div className="space-y-8 divide-y divide-gray-200">
        ...
        <div>
          <div>
            <h3 className="text-lg font-medium leading-6 text-gray-900">Sending transaction description</h3>
          </div>
        ...
        <div>
          <div>
            <h3 className="text-lg font-medium leading-6 text-gray-900">Sending date</h3>
          </div>
