              ...
              <div className="flex">
                ...
                <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                  ...
                  <a
                    href="#"
                    onClick={() => setActive(1)}
                    className={`inline-flex ${bebas_neue.className} items-center border-b-2 ${active===1?"border-slate-300":"border-transparent text-black"} px-1 pt-1 text-lg font-medium hover:border-b-4 hover:border-slate-300 hover:text-gray-900`}
                  >
                    Currency Exchange
                  </a>
                  <a
          ...
          <Disclosure.Panel className="sm:hidden">
            <div className="space-y-1 pt-2 pb-3">
              ...
              <Disclosure.Button
                ...
                href="#"
                onClick={() => setActive(1)}
                className={`block ${bebas_neue.className} border-l-4 py-2 pl-3 pr-4 text-base font-medium  ${active===1?'text-black border-slate-500 bg-slate-50':'text-gray-500 border-transparent hover:border-gray-300 hover:bg-gray-50 hover:text-gray-700'}`}
              >
                Currency Exchange
              </Disclosure.Button>
              <Disclosure.Button
